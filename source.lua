...
local NEVERLOSE = {
	...
	Themes = {
		...
		BlackColor = Color3.fromRGB(45, 45, 45),
		HeaderColor = Color3.fromRGB(55, 55, 55),
		TraceColor = Color3.fromRGB(120, 120, 120),
		MainColor = Color3.fromRGB(102, 153, 255),
		MainColorDrop = Color3.fromRGB(50, 50, 70),
